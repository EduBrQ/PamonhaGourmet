...
<div class="navbar">
    <ul class="navbar-container">
        ...
        <li class="nav-item "><a href="/contatos" class="left-underline nav-button" data-scroll>Contatos</a></li>
        <li class="nav-item active"><a href="/pamonhas" class="left-underline nav-button" data-scroll>Pamonhas</a></li>
