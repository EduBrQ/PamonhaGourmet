<style>
    ...
    .parallax.p2 {
        background: url(https://i0.wp.com/anadoces.com/wp-content/uploads/2018/05/Pamonha-de-milho-Receita-caseira.jpg?fit=1280%2C720&ssl=1) no-repeat fixed 50% 0;
        background-size: cover;
        color: #fff;
    }
    .parallax.p3 {
...
<div class="navbar">
    <ul class="navbar-container">
        <li><img src="http://pamonhagourmet.com/img/logo-pamonha-gourmet.png" href="#" class="left-underline nav-button brand-logo" style="width:4%; height: 6%"></li>
        <li class="nav-item active"><a href="/contatos" class="left-underline nav-button" data-scroll>Contatos</a></li>
        <li class="nav-item "><a href="/pamonhas" class="left-underline nav-button" data-scroll>Pamonhas</a></li>
        <li class="nav-item "><a href="/" class="left-underline nav-button" data-scroll>Home</a></li>
    </ul>
</div>
</html>